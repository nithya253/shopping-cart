function displayItems(filter_id)
{
	...
	fetch("data/Myfile1.json").then((response)=>
		response.json()
		).then((myObject)=>
		{
...
{
	let cardDiv=`<img src="images/visa1.jpg"><img src="images/master1.jpg"><img src="images/amex1.jpg"><img src="images/discover1.jpg">`
